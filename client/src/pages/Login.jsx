    ...
    <div className="min-h-[calc(100vh-64px)] flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="text-[34px] leading-none text-brand-900 font-heading tracking-tight">Welcome back</h1>
          <p className="text-brand-500 mt-2">Sign in to your SyncLab workspace</p>
        </div>

        <div className="bg-white border border-brand-300">
          <div className="px-6 py-4 border-b border-brand-200">
            <h2 className="text-[15px] font-semibold text-brand-900 font-heading">Sign In</h2>
          </div>
          ...
          <div className="px-6 py-4 border-t border-brand-200 text-center">
            <p className="text-sm text-brand-500">
              ...
              <Link to="/register" className="font-semibold text-brand-800 hover:text-brand-700 transition-colors">
                Get started free
              </Link>
            </p>
          </div>
