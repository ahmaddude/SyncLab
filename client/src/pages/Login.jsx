    ...
    <div className="relative min-h-[calc(100vh-64px)] flex items-center justify-center px-4 py-12 overflow-hidden">
      ...
      <div className="w-full max-w-md relative">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-400 mt-2">Sign in to your SyncLab workspace</p>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              ...
              <input type="password" required value={password} onChange={(e) => setPassword(e.target.value)}
                className="w-full bg-ink-950 border border-line rounded-xl px-4 py-3.5 text-gray-100 placeholder-gray-600 focus:outline-none focus:border-gold/40" placeholder="Enter your password" />
            </div>
