    ...
    <div className="min-h-[calc(100vh-64px)] flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-neutral-50 font-['Space_Grotesk',sans-serif]">Create your account</h1>
          <p className="text-neutral-500 mt-2">Start collaborating with your team</p>
        </div>
